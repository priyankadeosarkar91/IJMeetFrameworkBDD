...
public class CreateQuickMeetingStepdefinition {
	...
	public void clickOnQuickMeetingButton() {
		Keyword.getWebElement(AccessUtilityFile.getLocator1("QuickmeetingButton")[0], AccessUtilityFile.getLocator1("QuickmeetingButton")[1]).click();
...
//	}
	...
	public void isPopupDisplayed() {
		boolean isPopupContent=Keyword.getWebElement(AccessUtilityFile.getLocator1("ModelPopupContent")[0], AccessUtilityFile.getLocator1("ModelPopupContent")[1]).isDisplayed();
		System.out.println("The model Popup is Displayed : " +isPopupContent);
		WebElement meetname=Keyword.getWebElement(AccessUtilityFile.getLocator1("ModelPopupMeetName")[0], AccessUtilityFile.getLocator1("ModelPopupMeetName")[1]);
		WebElement meeturl=Keyword.getWebElement(AccessUtilityFile.getLocator1("ModelPopupMeetUrl")[0], AccessUtilityFile.getLocator1("ModelPopupMeetUrl")[1]);
	...
	public void the_copy_the_meeting_URL_for_the_session_created_by_clicking_on_the_copy_button() {
		WebElement modelPopupcopyButton=Keyword.getWebElement(AccessUtilityFile.getLocator1("ModelPopupCopyButton")[0], AccessUtilityFile.getLocator1("ModelPopupCopyButton")[1]);
	...
	public void isMsgDisplayedforMeetingLinkCopiedSuccessFully() {
		WebElement modelPopupcopyButton=Keyword.getWebElement(AccessUtilityFile.getLocator1("MsgLinkCopiedSuccessfully")[0], AccessUtilityFile.getLocator1("MsgLinkCopiedSuccessfully")[1]);
	...
	public void the_Modal_Pop_up_is_closed_by_clicking_on_the_cancel_button() {
		Keyword.getWebElement(AccessUtilityFile.getLocator1("CloseModelPopup")[0], AccessUtilityFile.getLocator1("CloseModelPopup")[1]);
	}
